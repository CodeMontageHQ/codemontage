module ProjectControllerHelper
  ...
  def code_later_url
     ...
     return "https://www.google.com/calendar/render?action=TEMPLATE&text=Code+with+CodeMontage&details=For+ideas,+visit+http://codemontage.com/projects.&location=Anywhere&sf=true&output=xml&dates=" + code_later_start + "/" + code_later_end
  end
